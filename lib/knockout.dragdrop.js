...
(function (factory) {
    if (typeof define === "function" && define.amd) {
        ...
        var get_knockout = require("./get-ko");
        // CommonJS or Node: dependency on "knockout" via having it set especially.
        // call:
        //      require('knockout-dragdrop/lib/get-ko')(knockout);
        module.exports = factory( get_knockout() );
    } else {
